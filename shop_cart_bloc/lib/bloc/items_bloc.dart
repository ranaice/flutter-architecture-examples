...
class ItemsBloc extends BlocBase {
  StreamController _controller = StreamController<List<ShopItem>>();

  Stream<List<ShopItem>> get stream => _controller.stream;
  ...
  void changeAddedToCart(ShopItem item) {
    item.addedToCart = !item.addedToCart;
    _controller.add(shopItems);
  }
